...
class DBManager(
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db!!.execSQL("CREATE TABLE IF NOT EXISTS 'homeless' ('h_num'	INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,'h_name'	TEXT NOT NULL,'h_birth'	TEXT,'h_phone'	TEXT,'h_photo'	TEXT,'h_hotlist'	INTEGER NOT NULL);")
        ...
        db!!.execSQL("CREATE TABLE IF NOT EXISTS 'location' ('c_num'	INTEGER PRIMARY KEY NOT NULL,'l_addr'	TEXT NOT NULL,'l_lat'	REAL NOT NULL,'l_lon'	REAL NOT NULL);")
        db!!.execSQL("CREATE TABLE IF NOT EXISTS 'photo' ('p_filename'	TEXT PRIMARY KEY NOT NULL,'c_num'	INTEGER NOT NULL);")
