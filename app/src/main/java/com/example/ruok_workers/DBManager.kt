...
class DBManager(
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db!!.execSQL("CREATE TABLE IF NOT EXISTS homeless (h_num INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,h_name TEXT NOT NULL,h_birth TEXT,h_phone TEXT,h_photo TEXT);")
